...
main (int argc, char *argv[])
{
  ...
  pcl::PointCloud<pcl::PointXYZ>::Ptr model_tmp (new pcl::PointCloud<pcl::PointXYZ> ());
  ...
  //  Load clouds
  //
  if (pcl::io::loadPCDFile (model_filename_, *model_tmp) < 0)
  {
  ...
  pcl::copyPointCloud(*model_tmp, *model);
