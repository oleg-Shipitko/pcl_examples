...
main (int argc, char** argv)
{
  ...
  pcl::PrincipalCurvatures descriptor = principalCurvatures->points[5];
  std::cout << descriptor << std::endl;

  pcl::PCDWriter writer;
  writer.write<pcl::PrincipalCurvatures> ("principal_curvatures.pcd", *principalCurvatures, false); 
